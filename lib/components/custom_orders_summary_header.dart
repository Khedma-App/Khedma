...
class CustomOrdersSummaryHeader extends StatelessWidget {
  const CustomOrdersSummaryHeader({super.key});
      ...
      children: [
        ...
        Positioned(
          ...
          child: Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              buildStatCard("3", "نزاع\nملغية", Colors.orange),
              buildStatCard("1", "جارية", Colors.red),
              buildStatCard("4", "مكتملة", Colors.green),
              buildStatCard("8", "الإجمالي", Colors.black),
            ],
          ),
        ),
      ],
...
Widget buildStatCard(String count, String title, Color color) {
  return Container(
    width: kWidth(80),
    height: kHeight(120),
